...
[
    ...
    },
    {
      ...
      text: "Ce projet repose sur l’étude de nouvelles perceptions par le numérique : mêler le mouvement du corps et les arts numériques en s’appuyant sur la notion d’art-thérapie. Lâcher-Prise est une installation interactive qui propose à la personne de se laisser aller pendant quelques instants, en se libérant par le mouvement de son corps. Ses mouvements génèrent du son et des visuels interagissant avec elle en suivant certaines parties de son corps. En fonction de la vitesse des mouvements, 3 états sont possibles : calme, joie, bonheur. Pour ce projet, j’ai réalisé l’identité visuelle de l’installation (logotype), que j’ai déclinée sur des supports de communication web et print (site, flyer,affiche), ainsi que la programmation des visuels sur Processing pour les trois états. Enfin, j’ai été filmée en train de danser dans l’installation pour qu’une bande d’annonce soit ensuite réalisée."
    },
    {
      routerTitle: "ElViaje",
      title:"El viaje", 
