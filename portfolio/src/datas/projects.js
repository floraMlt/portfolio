...
[
    {
      ...
      img: require("@/assets/img/projetIllus/capSciencesMain.jpg"),
      date: "Janvier-Mars 2017",
      link: "",
      otherImg: [require("@/assets/img/projetIllus/capSciences2.jpg"), require("@/assets/img/projetIllus/capSciences3.jpg"), require("@/assets/img/projetIllus/capSciences4.jpg")],
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/cadencesMain.jpg"),
      date: "Mars 2017",
      link: "",
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/boulangerieMain.jpg"),
      date: "Juillet 2017",
      link: "",
      otherImg: [],
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/causetteMain.jpg"),
      date: "Décembre 2016",
      link: "",
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/neonDemonMain.jpg"),
      date: "Novembre 2018",
      link: "",
      otherImg: [],
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/expressionsMain.jpg"),
      date: "Avril 2019",
      link: "",
      otherImg: [require("@/assets/img/projetIllus/expressions2.jpg"), require("@/assets/img/projetIllus/expressions3.jpg"), require("@/assets/img/projetIllus/expressions11.jpg"), require("@/assets/img/projetIllus/expressions6.jpg"), require("@/assets/img/projetIllus/expressions4.jpg"), require("@/assets/img/projetIllus/expressions5.jpg"), require("@/assets/img/projetIllus/expressions7.jpg"), require("@/assets/img/projetIllus/expressions8.jpg"), require("@/assets/img/projetIllus/expressions9.jpg"), require("@/assets/img/projetIllus/expressions10.jpg")],
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/photoMain.jpg"),
      date: "Octobre 2016",
      link: "",
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/dessinsMain.jpg"),
      date: "2016-2020",
      link: "",
    ...
    },
    {
      ...
      date: "Avril-Mai 2018",
      link: "",
      otherImg: [require("@/assets/img/projetIllus/viaje4.jpg"), require("@/assets/img/projetIllus/viaje3.jpg"), require("@/assets/img/projetIllus/viaje5.jpg"), require("@/assets/img/projetIllus/viaje2.jpg")],
      text: "Installation interactive relatant les péripéties d'un héro devant sauver son royaume d'une terrible menace. L'utilisateur est immergé dans l’histoire grâce aux sons, images et interactions et aura le pouvoir de faire avancer l’histoire. En effet, sans la collaboration du spectateur, l’histoire n’avance pas et reste au même stade. L’histoire mêle récit de voyage, d’aventure et fantasy. Dans l’installation, la narration de l’histoire est entrecoupée de mini-jeux permettant de faire avancer l’histoire. Si le spectateur réussit le mini-jeu, l’histoire continue, si au contraire celui-ci échoue il doit recommencer le mini-jeu pour finir par le réussir et ainsi avancer dans l’histoire. Les mini-jeux ont nécessité l'utilisation de différents types de capteurs afin de pouvoir interagir avec le joueur. Installation réalisée avec Processing."
    },
    {
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/wireframeMain.jpg"),
      date: "Octobre 2019",
      link: "",
      otherImg: [require("@/assets/img/projetIllus/wireframe2.jpg"), require("@/assets/img/projetIllus/wireframe3.jpg"), require("@/assets/img/projetIllus/wireframe4.jpg")],
    ...
    },
    {
      ...
      img: require("@/assets/img/projetIllus/anartmorphoseMain.jpg"),
      date: "Mars-Mai 2018",
      link: "",
      otherImg: [require("@/assets/img/projetIllus/anartmorphose7.jpg"), require("@/assets/img/projetIllus/anartmorphose4.jpg"), require("@/assets/img/projetIllus/anartmorphose8.jpg"), require("@/assets/img/projetIllus/anartmorphose6.jpg"), require("@/assets/img/projetIllus/anartmorphose2.jpg"), require("@/assets/img/projetIllus/anartmorphose3.jpg"), require("@/assets/img/projetIllus/anartmorphose5.jpg")],
      text: "Ce projet est un environnement 3D réalisé sur Unity. Il présente un musée «semi-imaginaire» où sont exposées des représentations 3D d’oeuvres de l’Histoire de l’Art. Ainsi, l’utilisateur se promène autour des oeuvres et peut les découvrir d'une nouvelle façon. Les oeuvres présentées sont modélisées avec le principe d’anamorphose, ainsi les tableaux normalement 2D sont représentés en 3D et les sculptures sont décomposées dans l’espace. L’utilisateur ne voit donc l’oeuvre que sous un certain angle, le reste du temps il ne verra que des formes abstraites."
    },
    {
